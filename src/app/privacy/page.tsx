        ...
        <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 text-slate-900 dark:from-slate-950 dark:to-slate-900 dark:text-slate-100">
            <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="space-y-8">
                    ...
                    <p>We may update this Privacy Policy periodically. We will notify you of any material changes.</p>

                    <h2>8. Contact Us</h2>
                    <p>For questions about this Privacy Policy or our data practices, please contact us through our Contact page.</p>
                </div>
            </div>
        </div>
            )
